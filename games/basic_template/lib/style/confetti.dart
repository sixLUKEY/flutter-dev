...
class _ConfettiState extends State<Confetti>
  ...
  void initState() {
    ...
    _controller = AnimationController(
      // We don't really care about the duration, since we're going to use the controller on loop anyway
...
class _PaperSnipping {
  ...
  final double ySpeed = 50 + _random.nextDouble() * 1.5;
