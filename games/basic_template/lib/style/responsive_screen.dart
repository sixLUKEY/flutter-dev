...
// A widget that makes it easy to create a screen with a square-ish main area,
// a smaller menu area, and a small area for a message on top.
// It works in both orientations on mobile- and tablet-sized screens.
class ResponsiveScreen extends StatelessWidget {
  // This is the "hero" of the screen. It's more or less square, and will be placed
  // in the visual center of the screen.
  final Widget squarishMainArea;

  // The second-largest area after `squarishMainArea`. It can be narrow or wide
